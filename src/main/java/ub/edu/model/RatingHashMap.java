...
public abstract class RatingHashMap{
    ...
    public abstract List<HashMap<String, String>> getAllFilmRatings(String typeCalcul);
    public abstract List<HashMap<String, String>> getAllSerieRatings(String typeCalcul);
}
